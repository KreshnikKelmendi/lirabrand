...
export default function Footer() {
      ...
      <div className="mx-auto py-12 lg:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 items-start">
          ...
          <div className="flex flex-col items-center md:items-start space-y-4">
            ...
            >
              <div className="relative h-24 w-24 sm:h-28 sm:w-28 transition-all duration-500 group-hover:scale-110 group-hover:rotate-6">
                <Image
  ...
  {/* LIRA BRAND Title - At the end/bottom */}
  <div className="mt-12 lg:mt-6 pt-8 border-t border-gray-200/60">
          <h1 
            className="font-foregen text-6xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-[10rem] tracking-wide select-none"
            style={{
              color: '#000000',
              textShadow: '1px 2px 8px rgba(0,0,0,0.15), 0 0 20px rgba(0,0,0,0.05)',
              letterSpacing: '0.1em'
            }}
          >
            LIRA BRAND
