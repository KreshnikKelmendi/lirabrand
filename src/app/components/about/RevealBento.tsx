  ...
  return (
    <Block className="col-span-12 row-span-2 md:col-span-6 flex items-center relative overflow-hidden" ref={ref}>
      ...
      <div className="absolute inset-0 z-0">
        <Image
          src="/assets/487786048_1265413888917456_4464519389769385379_n.jpg"
          alt="Background"
          fill
...
const SocialsBlock = () => (
  <>
    ...
    />
    <ImageBlock
      src="/assets/482091979_18374565301184030_6899814858407836004_n.jpg"
      alt="Lira Brand Tea"
    />
    <ImageBlock
      src="/assets/486809174_1261131792678999_3569231263362330969_n.jpg"
      alt="Lira Brand Product"
    />
  </>
);
